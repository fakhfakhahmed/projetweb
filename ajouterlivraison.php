...
<div class="col-lg-6" style="margin-top: 100px;margin-left: 375px;">
    <div class="card">
        ...
        <div class="card-body card-block">
            <form action="ajouterlivrai.php" method="post" name="myform" enctype="multipart/form-data" class="form-horizontal" onsubmit="return testlivraison()">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                                <input type="date" id="date_d" name="date_depart" placeholder="Text" class="form-control" >
                        <small id="er" class="form-text ">Ajouter date de depart de la livraison</small>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3">
                    ...
                    <div class="col-12 col-md-9">
                                <input type="date" id="date_a" name="date_arrive" placeholder="Text" class="form-control" >
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <select name="id_commande" id="cmd" class="form-control">
                        ...
                        <small id="errr" class="form-text text-muted">Ajouter identifiant de la commande</small>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3">
                    ...
                    <div class="col-12 col-md-9">
                        ...
                        <small id="errrr" class="form-text text-muted">Ajouter identifiant du client</small>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3">
                    ...
                    <div class="col-12 col-md-9">
                        <select name="id_livreur" id="livreur" class="form-control">
                        ...
                        <small id="errrrr" class="form-text text-muted">Ajouter CIN du livreur</small>
                    </div>
                </div>
