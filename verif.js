...
function testlivreur()
{
    ...
    c3=document.getElementById('prenom');
    c4=document.getElementById('etat');
    c5=document.getElementById('matricule');
    c6=document.getElementById('adresse');
    c7=document.getElementById('tel');
